...
################################################################
# design_1.bd — derived from lab3 P3_BD_S2026 (same hierarchy: perifs / DDR / axi_perifs),
# Lab-only board GPIO removed; PetaLinux peripherals: UART, timer, INTC, DDR, MDM, Bloom on M03 @ 0x44A00000.
#
...
if { $list_projs eq "" } {
   error "No project open. Source build.tcl instead of this file directly."
}

# Block design name (must match build.tcl / Vivado project)
...
proc create_hier_cell_axi_perifs { parentCell nameHier } {
  ...
  # Create instance: ilconcat_0 — UART + timer only (no lab GPIO)
  ...
  # Bloom accelerator
  set bloom_axi_0 [ create_bd_cell -type ip -vlnv jfrankel:user:bloom_axi bloom_axi_0 ]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M03_AXI [get_bd_intf_pins smartconnect_1/M03_AXI] [get_bd_intf_pins bloom_axi_0/s_axi]
  ...
  [get_bd_pins bloom_axi_0/aresetn]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/axi_perifs/bloom_axi_0/s_axi/reg0] -force
