...
proc create_root_design { parentCell } {
  ...
  # Create instance: bloom_axi_0, and set properties
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins bloom_axi_0/s_axi]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs bloom_axi_0/s_axi/reg0] -force
  ...
  # validate_bd_design and save_bd_design are called by the parent
  # build script after exclude_bd_addr_seg adjustments.
}
